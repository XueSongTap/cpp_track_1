...
int main()
{
	test(0);	// 默认模式，类似 TCP：正常模式，无快速重传，常规流控	avgrtt=4642 maxrtt=6761 tx=274
	test(1);	// 普通模式，关闭流控等 				avgrtt=165 maxrtt=576 tx=1270
	test(2);	// 快速模式，所有开关都打开，且关闭流控  avgrtt=145 maxrtt=403 tx=1374
